...
<% if (config.activeVisit) { %>
    ...
    <div class="active-visit-started-at-message">
        ${ui.message("intelehealth.patientHeader.activeVisit.at", config.activeVisitStartDatetime)}
    </div>

    <% if (config.showVisitTypeOnPatientHeaderSection == false) { %>
        <% if (config.activeVisit.admitted) { %>
        <div class="active-visit-message">
            ${ui.message("intelehealth.patientHeader.activeVisit.inpatient", ui.format(config.activeVisit.latestAdtEncounter.location))}
        </div>
        <% } else { %>
        <div class="active-visit-message">
            ${ui.message("intelehealth.patientHeader.activeVisit.outpatient")}
        </div>
        <% } %>
    <% } else { %>
        ...
        <% } else { %>
            <div class="active-visit-message">
                ...
                <% } else { %>
                    ${ui.message("intelhealth.patientHeader.activeVisit.outpatient")}
                <% } %>
            </div>
        <% } %>
    <% } %>
