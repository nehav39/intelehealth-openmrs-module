...
import org.openmrs.module.intelehealth.IntelehealthConstants;
...
//		String patientId = app.getConfig().get("patientId").getTextValue();
//		model.addAttribute("patientId", patientId);
//		model.addAttribute("patientID", patient.getId());

        // used to determine whether or not we display a link to the patient in the results list
//        model.addAttribute("canViewVisits", Context.hasPrivilege(IntelehealthConstants.PRIVILEGE_PATIENT_VISITS));
